...
public:
	...
	/*** IUnknown methods ***/
	STDMETHOD(QueryInterface)(THIS_ REFIID riid, LPVOID FAR *ppvObj) { return Proxy_QueryInterface(riid, ppvObj); }
	...
	STDMETHOD(CreateSurface)(THIS_ LPDDSURFACEDESC2 p1, LPDIRECTDRAWSURFACE7 FAR *p2, IUnknown FAR *p3) { return Proxy_CreateSurface(p1, p2, p3); }
	...
	STDMETHOD(GetDisplayMode)(THIS_ LPDDSURFACEDESC2 p1) { return Proxy_GetDisplayMode(p1); }
	...
	STDMETHOD(SetCooperativeLevel)(THIS_ HWND p1, DWORD p2) { return Proxy_SetCooperativeLevel(p1, p2); }
	STDMETHOD(SetDisplayMode)(THIS_ DWORD p1, DWORD p2, DWORD p3, DWORD p4, DWORD p5) { return Proxy_SetDisplayMode(p1, p2, p3, p4, p5); }
	STDMETHOD(WaitForVerticalBlank)(THIS_ DWORD p1, HANDLE p2) { return Proxy_WaitForVerticalBlank(p1, p2); }
...
public:
	...
	STDMETHOD(CreateDevice)(THIS_ REFCLSID p1, LPDIRECTDRAWSURFACE7 p2, LPDIRECT3DDEVICE7 *p3) { return Proxy_CreateDevice(p1, p2, p3); };
